        ...
        with gr.Column():
            with gr.Tabs():
                ...
                with gr.Tab("Single Image / Multi-Prompt"):
                    ...
                    with gr.Group("Generation Settings"):
                        with gr.Row():
                        ...
                        prompt = gr.Textbox(
                            ...
                            value='',
                            lines=4,
                            info="Use '[seconds] prompt' format on new lines ONLY when 'Use Multi-line Prompts' is OFF. Example [0] starts second 0, [2] starts after 2 seconds passed and so on. Applies to both models."
                        )
                        ...
                        with gr.Row():
                            use_multiline_prompts = gr.Checkbox(
                                ...
                                value=False,
                                info="ON: Each line is a separate gen (new seed per line if random). OFF: Try parsing '[secs] prompt' format."
                            )
                            latent_window_size = gr.Slider(
                                ...
                                step=1,
                                visible=True,
                                info="Controls generation chunk size. Affects section/loop count and duration (see info above prompt). Default 9 recommended."
                            )

                    with gr.Group("Output Options"):
                        with gr.Row():
                    ...
                    with gr.Group("Generation Controls"):
                        with gr.Row():
                ...
                with gr.Tab("Batch Processing"):
                    with gr.Group("Input/Output Folders"):
                    ...
                    with gr.Group("Batch Output Options"):
                        with gr.Row():
                ...
                # Load from Metadata Tab
                with gr.Tab("Load from Metadata File"):
                    with gr.Group("Metadata Import"):
